...
@CucumberOptions(features = "src/test/resources/Features/register",glue = {""}, 
monochrome =true,
plugin = {"pretty", "html:target/Html-reports/cucumber-reports.html","json:target/Json-reports/cucumber.json",
